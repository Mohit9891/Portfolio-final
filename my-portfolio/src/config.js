...
const CONFIG = {
  ...
  bio: "Crafting seamless digital experiences with chai in hand — obsessing over the nuances that make interfaces feel alive.",
  email: "mohitprajapati1412009@gmail.com",
  location: "Remote / Global",

  roles: ["Designer", "Developer", "Creator", "Builder"],

  socials: {
    LinkedIn: "https://www.linkedin.com/in/mohit-prajapati-484a40275/",
    GitHub:   "https://github.com/Mohit9891",
  },

  stats: [
    { number: "∞",    label: "Cups of Chai" },
    { number: "100%", label: "Remote & Happy" },
  ],
  ...
  journal: [
    { emoji: "☕", title: "Why chai breaks make better products",           meta: "5 min read · Jan 2026", href: "#" },
    { emoji: "⚡", title: "Design systems that feel human, not mechanical", meta: "7 min read · Dec 2025", href: "#" },
    { emoji: "🌐", title: "Working remotely without losing your rhythm",    meta: "4 min read · Nov 2025", href: "#" },
    { emoji: "🎨", title: "The micro-interactions that change everything",  meta: "6 min read · Oct 2025", href: "#" },
  ],

  hlsSrc: "https://stream.mux.com/Aa02T7oM1wH5Mk5EEVDYhbZ1ChcdhRsS2m1NYyx4Ua1g.m3u8",
};
